...
const FIXTURES_ROOT = join(__dirname, "fixtures", "pii-pages");
...
const EXPECTATIONS: Expectation[] = [
  ...
  // Shell-script archetype — exercises PASSWORD_ATTR rule coverage on common
  // shell idioms that should NOT redact: `password_*` config keys (prefix is
  // part of the key name, not a value assignment) and the legacy mysql
  // `-p<password>` CLI flag.
  { slug: "shell-script-passwords", maxRedactions: 0, perCategoryCap: 0 },
];
